...
if("TRUE" STREQUAL "TRUE")
  set(laser_scan_SOURCE_PREFIX /home/dance/Epuck-Robot-Gazebo/src/laser_scan)
  set(laser_scan_DEVEL_PREFIX /home/dance/Epuck-Robot-Gazebo/devel)
  ...
  set(laser_scan_INSTALL_PREFIX /home/dance/Epuck-Robot-Gazebo/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'laser_scan' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'laser_scan' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dance/Epuck-Robot-Gazebo/src/laser_scan/${idir}'.  ${_report}")
    endif()
...
set(laser_scan_EXPORTED_TARGETS "laser_scan_generate_messages_cpp;laser_scan_generate_messages_eus;laser_scan_generate_messages_lisp;laser_scan_generate_messages_nodejs;laser_scan_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${laser_scan_dep}_FOUND)
      find_package(${laser_scan_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${laser_scan_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
...
set(pkg_cfg_extras "laser_scan-msg-extras.cmake")
